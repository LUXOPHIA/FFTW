! Generated automatically.  DO NOT EDIT!
  ...
  interface
    ...
    type(C_PTR) function fftw_copy_plan(p) bind(C, name='fftw_copy_plan')
      import
      type(C_PTR), value :: p
    end function fftw_copy_plan
...
! Unable to generate Fortran interface for fftw_threads_set_callback
  ...
  interface
    ...
    type(C_PTR) function fftwf_copy_plan(p) bind(C, name='fftwf_copy_plan')
      import
      type(C_PTR), value :: p
    end function fftwf_copy_plan
